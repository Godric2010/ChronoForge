...
async fn setup_test(task_one_id: Uuid, task_two_id: Uuid) -> SqliteTimeEntryRepository {
    ...
    test_db_builder::create_fake_task_entry(&pool, project_id, task_one_id, "Task1").await;
    test_db_builder::create_fake_task_entry(&pool, project_id, task_two_id, "Task2").await;
...
async fn create_time_entry_and_its_in_the_database() {
    ...
    let time_entry = TimeEntry {
        id: Uuid::new_v4(),
        task_id: task_one_id,
        start_time: utc_date_time(2026, 5, 15),
        end_time: utc_date_time(2026, 5, 14),
        created_at: utc_date_time(2026, 5, 15),
        updated_at: utc_date_time(2026, 5, 14),
    };
...
async fn upsert_time_entry_with_newer_version() {
    ...
    updated_time_entry.task_id = task_two_id;
    updated_time_entry.start_time = utc_date_time(2026, 5, 14);
    updated_time_entry.end_time = utc_date_time(2026, 6, 14);
    updated_time_entry.updated_at = Utc.with_ymd_and_hms(2026, 5, 27, 22, 5, 0).unwrap();
...
async fn upsert_time_entry_with_older_version() {
    ...
    let time_entry = TimeEntry {
        ...
        end_time: utc_date_time(2026, 5, 14),
        created_at: utc_date_time(2026, 5, 15),
        updated_at: utc_date_time(2026, 5, 16),
    };
    ...
    updated_time_entry.start_time = utc_date_time(2026, 5, 14);
    updated_time_entry.end_time = utc_date_time(2026, 6, 14);
    updated_time_entry.updated_at = utc_date_time(2026, 5, 15);
...
async fn update_time_entry_and_its_values_are_updated_in_the_database() {
    ...
    let updated = TimeEntry {
        id: original.id,
        task_id: task_two_id,
        start_time: utc_date_time(2026, 4, 25),
        end_time: utc_date_time(2026, 4, 26),
        created_at: utc_date_time(2026, 4, 26),
        updated_at: utc_date_time(2026, 4, 26),
    };
