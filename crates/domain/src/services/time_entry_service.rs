...
mod time_entry_service_tests {
    ...
    async fn create_manual_entry() {
        ...
        let start_time = utc(2026, 5, 8, 22, 5);
        let end_time = utc(2026, 5, 8, 22, 7);
        let result = context
            .service
    ...
    async fn create_time_entry_with_invalid_time() {
        ...
        let end_time = utc(2026, 5, 8, 22, 5);
        let start_time = utc(2026, 5, 8, 22, 7);
        let result = context
            .service
            .create_manual(start_time, end_time, context.task_ids[0])
            .await;
    ...
    async fn edit_time_entry() {
        ...
        let original_start_time = utc(2026, 5, 9, 14, 10);
        let original_end_time = utc(2026, 5, 9, 14, 13);
        ...
        let modified_start_time = utc(2025, 5, 9, 14, 10);
        let modified_end_time = utc(2025, 5, 9, 15, 13);
    ...
    async fn edit_time_entry_where_end_time_is_before_start_time() {
        ...
        let modified_start_time = utc(2026, 5, 9, 14, 10);
        let modified_end_time = utc(2025, 5, 9, 15, 13);
    ...
    async fn assign_time_entry_to_new_task() {
        let context = Context::new().await;
        let start_time = utc(2026, 5, 9, 14, 10);
        let end_time = utc(2026, 5, 9, 14, 13);
        let time_entry = context
            .service
            .create_manual(start_time, end_time, context.task_ids[0])
            .await
