...
pub struct ProjectEditOutput {
    pub project_name: String,
    pub time_limit: Option<u32>,
}

#[derive(Clone, Copy)]
enum ProjectEditActions {
    Next,
    Previous,
}

pub struct ProjectEditWidget {
    name_input: TextEditElement,
    time_limit_checkbox: CheckboxElement,
    time_limit_input: TimeEditElement,

    active_element_index: u8,
    input_map: InputMap<ProjectEditActions>,
}

impl ProjectEditWidget {
    fn create_input_map() -> InputMap<ProjectEditActions> {
        let key_bindings = vec![
            ...
            KeyBinding {
                ...
                action: ProjectEditActions::Previous,
                display_in_footer: false,
            },
        ];
        InputMap::new("Project Edit Action", key_bindings)
    }
    pub fn empty() -> Self {
    ...
    pub fn new(project: &Project) -> Self {
        ...
        let mut name_input = TextEditElement::new(Some(project.name.clone()), InputMode::Naming);
        name_input.set_active(true);
        Self {
            name_input,
    ...
    fn select_previous_field(&mut self, max_element_idx: u8) {
...
impl DialogWidget for ProjectEditWidget {
    ...
    fn handle_key(&mut self, key: KeyEvent) {
        ...
        match action {
            ...
            Some(a) => match a {
                ProjectEditActions::Next => self.select_next_field(max_element_idx),
                ProjectEditActions::Previous => self.select_previous_field(max_element_idx),
            },
        }
    }
